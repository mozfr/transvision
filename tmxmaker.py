...
if __name__ == "__main__":
    ...
    dirs1 = os.listdir(fr)
    dirs2=["b2g", "browser", "calendar", "chat", "dom", "editor", "embedding", "extensions", "intl", "layout", "mail", "mobile", "netwerk", "other-licenses", "security", "services", "suite", "testing", "toolkit", "webapprt"]
